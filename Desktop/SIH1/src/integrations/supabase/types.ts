    ...
    Tables: {
      ...
      industries: {
        Row: {
          ...
          email: string | null
          id: string
          internship_capacity: number | null
          location: string | null
          required_skill: Json | null
          role: string | null
          sector: string | null
        }
        Insert: {
      ...
      matches: {
        ...
        Relationships: [
          {
            foreignKeyName: "matches_industry_id_fkey"
            columns: ["industry_id"]
            isOneToOne: false
